...
function w(a,b){for(var c=a.className,c=c?c.split(" "):[],d=0,f=c.length;d<f;d++)if(b&&b===c[d])return l;return m}function x(a,b){var c="";if(w(a,b))return m;a.className&&(c=" ");a.className=a.className+c+b;return l}function y(a,b){var c,d=[],f,g;if(!w(a,b))return m;c=a.className.split(" ");f=0;for(g=c.length;f<g;f++)b!==c[f]&&d.push(c[f]);a.className=d.join(" ");return l}function ma(a,b){return w(a,b)?y(a,b):x(a,b)}
...
function D(a,b){var c=a.style,d,f,g;for(d in b)f=d,g=b[d],ea(g)&&(g+="px"),c[f]=g}function sa(a){return v.defaultView.getComputedStyle(a,t)}function E(a,b){return a.appendChild(b)}function ta(a){return a.parentNode.removeChild(a)}function ua(a,b){if(!b)return a.innerHTML;a.innerHTML=b}var k=window,v=document,l=!0,m=!1,t=null,F=ia(),G,I,va="orientationchange",J=1.70158,K,L=k.C={};Date.now||(Date.now=function(){return+new Date});
...
R=Ba?L.Animation=G({extend:K,init:function(a,b,c){c=c||{};this.D=c.onComplete||s;this.a=a;R.id++;this.c="ciranim"+R.id;a=c.duration||R.Duration;var d=c.ease||"ease",f,g={};for(f in b)g[f]=b[f],ea(g[f])&&(g[f]+="px");this.i=g;g=ca(ca(JSON.stringify(g),'"',""),",",";");Q.insertRule("@"+N+"keyframes "+this.c+"{to"+g+"}",Q.cssRules.length);ha(d)||(d=[d]);b=this.c;f=N;for(var g=0,h=d.length,p="";g<h;g++)p+=f+"animation:"+b+" "+a+"ms "+d[g]+" 0s 1 normal both;";Q.insertRule("."+b+"{"+p+"}",Q.cssRules.length);
c.manual||this.start()},properties:{X:function(){B(this.a,Ca+"End",this.end);B(this.a,"animationend",this.end)},dispose:function(){this.stop();this.d()},start:function(){function a(a){var d=Q.cssRules,f=d.length,g;b.X();if("webkit"===M){for(;f--;)g=d[f].name||(""+d[f].selectorText).split(".")[1],g===b.c&&Q.deleteRule(f);y(b.a,b.c);D(b.a,b.i)}b.D(a)}var b=this;b.end=a;A(b.a,Ca+"End",a);A(b.a,"animationend",a);x(b.a,b.c)},stop:function(){var a={};a[N+"animation-play-state"]="paused";D(this.a,a);this.X()}}}):
...
U=Ia?L.Transition=G({extend:K,init:function(a,b,c){c=c||{};c.onComplete=c.onComplete||s;U.id++;this.c="cirtrans"+U.id;var d=[];aa({},b);var f,g=c.duration||U.Duration,h=c.ease||"ease";ha(h)||(h=[h]);for(f in b)d.push(f);f=Ka;for(var p=0,q=h.length,d=""+(f+"transition-property:"+d.join(" ")+";"+f+"transition-duration:"+g+"ms;");p<q;p++)d+=f+"transition-timing-function:"+h[p]+";";T.insertRule("."+this.c+"{"+d+"}",T.cssRules.length);this.a=a;this.i=b;this.Ma=c;c.manual||this.start()},properties:{dispose:function(){this.stop();
...
function Pa(a,b,c,d,f){ga(c)&&(f=c,c=t);ga(d)&&!f&&(f=d,d=t);d&&(d=Qa[d]);c={duration:c,ease:d,onComplete:f};if(Ra)b=new Sa(a,b,c);else{d=L.Tweener;f=a.style;var g;a=sa(a);var h,p,q={};for(g in b)h=Ta(b[g]),p=a.getPropertyValue(g),p=!p||"none"===p?0:1*Ta(p)[2],q[g]={from:p,to:1*h[2]||0,prefix:h[1],suffix:h[3]};b=new d(f,q,c)}this.k.push(b)}function Ta(a){a=""+(a||"");return a.match(/^(.*?)([0-9\.]+)(.*)$/)}var Ua=L.$.ia,Sa=L.Animation||{},Ra=Sa.support,Qa={};
...
L.HashQuery=G({extend:K,properties:{typeCast:function(a){var b=ba(a);return a===b&&(a=a.match("^[\"'](.*)[\"']$"))?a[1]:b},makeHash:function(a){var b="#"+a.mode;a=a.vars;var c="?",d;for(d in a)b+=c+d+"="+JSON.stringify(a[d]),c="&";return encodeURI(b)},setHash:function(a){location.hash=this.makeHash(a);return l},parseHash:function(a){var b,c,d,f;b=decodeURIComponent(a).split("#")[1];if(!b)return m;b=b.split("?");a=b[0];if(b[1]){c={};b=b[1].split("&");for(f=b.length;f--;)b[f]&&(d=b[f].split("="),c[d[0]]=
this.typeCast(d[1]))}return{mode:a,vars:c}},getHash:function(){return this.parseHash(location.hash)}}});L.Embed=function(a){var b=z(a.type.toLowerCase());b.controls=a.controls?l:m;b.preload=a.preload||"auto";b.autoplay=a.autoplay?l:m;b.loop=a.loop?l:m;b.src=a.dir+a.name+"."+a.suffix[0][0];return b};
L.Embed.supportcheck=function(a){if(!k["HTML"+a.type+"Element"])return m;var b=a.type.toLowerCase(),c=z(b);a=a.suffix;for(var d=[],f=0,g=a.length;f<g;f++)c.canPlayType(b+"/"+a[f][1])&&d.push(a[f]);return!d.length?m:d};
L.Media=G({extend:K,init:function(a){this._super();var b=this,c=a.autoplay,d=a.loop,f,g=a.element||v.body;a.preload="auto";a.autoplay=a.loop=m;switch(a.type){case "Audio":f=L.Audio(a);break;case "Video":f=L.Video(a)}b.g=f;if(!f)return m;if(c){var h;h=this.contract(f,"canplay",function(){b.uncontract(h);b.play()})}d&&this.loop(l);a.oncanplay&&this.contract(f,"canplay",a.oncanplay);a.onended&&this.contract(f,"ended",a.onended);g.appendChild(f)},properties:{dispose:function(){ta(this.g);this.d()},getElement:e("g"),
getCurrent:function(){return this.g.currentTime},getDuration:function(){return this.g.duration},setCurrent:function(a){this.g.currentTime=a},loop:function(a){var b=this;b.h&&(b.uncontract(b.h),delete b.h);a&&(b.h=b.contract(b.g,"ended",function(){b.stop();b.play()}))},autoplay:function(){},play:function(){this.g.play()},pause:function(){this.g.pause()},stop:function(){this.setCurrent(0);this.pause()}}});L.Media.supportcheck=L.Embed.supportcheck;
L.Audio=function(a){a.type="Audio";a.suffix=L.Audio.support;return L.Embed(a)};L.Audio.support=L.Embed.supportcheck({type:"Audio",suffix:[["mp3","mpeg"],["wav","wav"],["ogg","ogg"],["m4a","mp4"]]});L.Sound=function(a){a.type="Audio";return new L.Media(a)};L.Sound.support=L.Audio.support;L.Video=function(a){a.type="Video";a.suffix=L.Video.support;return new L.Embed(a)};L.Video.support=L.Embed.supportcheck({type:"Video",suffix:[["webm","webm"],["mp4","mp4"],["ogv","ogg"]]});
L.Movie=function(a){a.type="Video";return new L.Media(a)};L.Movie.support=L.Video.support;
L.Ajax=G({extend:K,init:function(a){a&&this.request(a)},properties:{request:function(a){if("json"===a.dataType)return delete a.dataType,this.Sa(a);var b=a.url,c=a.callback||s,d=a.error||s,f=a.type||"GET",g="",h;a.cash||(a.query||(a.query={}),a.query["cirajaxcash"+Date.now()]="0");a.query&&(g=a.query,da(g)&&(g=n(g),g=encodeURI(g)));h=this.S=new XMLHttpRequest;h.onreadystatechange=function(){return 4!=h.readyState?m:200==h.status?c(h.responseText,h):d(h)};"GET"===f&&(b=-1!==b.indexOf("?")?b+"&":b+"?",
b+=g,g="");h.open(f,b);"POST"===f&&h.setRequestHeader("Content-Type","application/x-www-form-urlencoded");h.send(g)},abort:function(){this.S&&this.S.abort()},json:function(a){var b=a.callback,c=a.error;a.callback=function(a){b(JSON.parse(a))};a.error=function(a){c&&c(a)};this.request(a)}}});
L.Bind=G({extend:K,init:function(a){this.A=a;this.add()},properties:{dispose:function(){this.remove();this.d()},getHandler:e("A"),add:function(){this.V(l)},remove:function(){this.V(m)},V:function(a){a=a?A:B;for(var b in this.A.events)a(this.A.element,b,this.A.events[b])}}});
...
h[f]=d.pigment(a);g++}var d=this,f,g=0,h={};b=b||s;for(f in a)c(a[f]);return h},draw:function(a){var b=0,c=a.length,d;for(this.ba.clearRect(0,0,this.p.width,this.p.height);b<c;b++)d=a[b],this.ba.drawImage(d.image,d.x,d.y)}}});L.Brush.support=!!k.HTMLCanvasElement;
...
L.DragFlick=G({extend:K,init:function(a){this._super();a&&this.bind(a)},properties:{I:function(a){return a.changedTouches?a.changedTouches[0]:a},amount:function(a){var b=this,c,d,f=m;this.contract(a.element,I.switchdown,function(a){var h=b.I(a);c=h.pageX;d=h.pageY;f=l;ja(a)});this.contract(k,I.switchup,function(g){f&&(g=b.I(g),a.callback({x:g.pageX-c,y:g.pageY-d}),f=m)})},direction:function(a){this.amount({element:a.element,callback:function(b){var c=a.boundary||0,d={change:m,top:m,right:m,bottom:m,
left:m,amount:b};Math.abs(b.x)>c&&(0<b.x?d.right=l:0>b.x&&(d.left=l),d.change=l);Math.abs(b.y)>c&&(0<b.y?d.bottom=l:0>b.y&&(d.top=l),d.change=l);a.callback(d)}})},bind:function(a){function b(a,b,d){c.contract(a,b,function(a){d(c.I(a))})}var c=this,d=a.element,f=a.start||s,g=a.move||s,h=a.end||s,p=m,q=0,H=0;a.direction&&c.direction({element:d,boundary:a.boundary,callback:a.direction});b(d,I.switchdown,function(a){p=l;q=a.pageX;H=a.pageY;f({e:a,move:{x:q,y:H}})});b(v,I.switchmove,function(a){p&&g({e:a,
...
h=[]}function d(){f();c()}function f(){if(g.getOrientation().portrait)return a.portrait(),l;a.landscape()}var g=this,h=[];a.immediately&&f();if(a.one)return b(d),function(){c()};b(f);return function(){c()}}}});L.DeviceOrientation=G({extend:K,init:function(){this._super()},properties:{bind:function(a){this.unbind();this.o=this.contract(k,"deviceorientation",a)},unbind:function(){this.o&&this.uncontract(this.o)}}});L.DeviceOrientation.support="ondeviceorientation"in k;
L.DeviceMotion=G({extend:K,init:function(){this._super()},properties:{bind:function(a){this.unbind();this.o=this.contract(k,"devicemotion",a)},unbind:function(){this.o&&this.uncontract(this.o)}}});L.DeviceMotion.support="ondevicemotion"in k;var Y,Xa=!1,Ya,Za=new C.Mobile;Za.isMobile()&&(L.DeviceOrientation.support?(Y=L.DeviceOrientation,Ya=function(a){return a}):L.DeviceMotion.support&&(Y=L.DeviceMotion,Ya=function(a){return a.rotationRate}),Y&&(Xa=!0));Za=Za.dispose();
L.DeviceShake=G({extend:K,init:function(a){this._super();this.aa=new Y;this.sa=a.limit;this.za=a.waittime;this.pa=a.callback;this.bind()},properties:{dispose:function(){this.unbind();this.d()},bind:function(){var a=this,b,c;a.aa.bind(function(d){d=Ya(d);b||(b=d);c=Math.abs(d.beta-b.beta);c>a.sa&&(b=t,a.pa(d),setTimeout(function(){},a.za))})},unbind:function(){this.aa.unbind()}}});L.DeviceShake.support=Xa?l:m;
...
L.Observer=G({extend:K,init:function(a){a=a||{};if(a.single&&L.Observer.b)return L.Observer.b;this.L={};a.single&&(L.Observer.b=this)},properties:{on:function(a,b){var c=this.L;c[a]||(c[a]=[]);c[a].push(b)},one:function(a,b){function c(f){b(f);d.off(a,c)}var d=this;d.on(a,c)},off:function(a,b){var c=this.L;if(!b)return delete c[a],l;var d=c[a],f;if(!d)return m;for(f=d.length;f--;)if(b===d[f])return d.splice(f,1),0===d.length&&delete c[a],l;return m},fire:function(a,b){var c=this.L[a],d,f;if(!c)return m;
for(f=c.length;f--;)(d=c[f])&&d(b);return l}}});
...
L.ScriptLoad=G({extend:K,init:function(){this._super();this.j=[]},properties:{requests:function(a,b){function c(c){var g=a[c].callback;a[c].callback=function(a){g(a);f--;0===f&&b(d.j)};d.request(a[c])}for(var d=this,f=0,g=a.length;f<g;f++)c(f)},request:function(a){var b=this,c=z("script"),d;c.src=a.src;v.body.appendChild(c);b.j.push(c);a.callback&&(d=b.contract(c,I.load,function(){b.uncontract(d);a.callback.apply(this,arguments)}))}}});function Z(a){return $a?$.getResponseHeader(a):m}
function ab(a){var b=new XMLHttpRequest;b.onload=function(){a(b)};b.open("HEAD",location.href+"?update"+Date.now()+"=1");b.send(t);return b}var $,$a=m;
L.ServerMeta=G({extend:K,init:function(a){a=a||{};var b=a.callback||s;$?b($):$=ab(function(){$a=l;b($)})},properties:{date:function(a){return ab(function(b){b=new Date(b.getResponseHeader("Date"));a(b)})},connection:function(){return Z("Connection")},contentLength:function(){return Z("Content-Length")},lastModified:function(){return Z("Last-Modified")},server:function(){return Z("Server")},contentType:function(){return Z("Content-Type")},acceptRanges:function(){return Z("Accept-Ranges")},keepAlive:function(){return Z("Keep-Alive")}}});
...
L.Timer=function(a){function b(){P=Date.now();var a=g-(P-za)/1E3;0>a&&(a=0);Da=c(a);q(Da);if(P>Aa)return Va.stop(),H(),l;Wa=setTimeout(b,p);return m}function c(a){var b;b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({ka:a,ca:ya.Ia});b=d({ka:b,ca:ya.Ha,Ja:l});return a+"."+b}function d(a){var b=""+a.ka,c=a.ca,d=c-b.length;return!a.Ja?-1<d?f(d,0)+b:f(c,9):0<d?b+f(d,0):b.slice(0,c)}function f(a,b){var c="";for(b=""+b;0<a;)c+=b,a--;return c}var g=a.limit,h=1E3*g,p=1E3*a.interval,q=a.onupdate,H=a.ontimeup,
ya;a=a.template.split(".");ya={Ia:a[0].length,Ha:a[1].length};var za=0,P=0,Aa=h,Da=c(g),Wa,Va={getLimit:function(){return g},getTime:function(){return Da},getProgress:function(){return 1-(Aa-P)/h},setUpdate:function(a){q=a},setTimeup:function(a){H=a},countDown:function(){P=za=Date.now();Aa=za+h;b()},stop:function(){clearInterval(Wa)}};return Va};
L.Twitter=G({extend:K,properties:{G:"https://twitter.com/intent/tweet?",shareURL:function(a){var b=a.caption||"",c=a.name,d=a.hash,f=this.G;return f+=n({url:a.redirect_uri,text:b+(c?" \u300c"+c+"\u300d":"")+(d?" "+d:"")})}}});L.XML=G({extend:K,init:function(a){this.a=z("div");this.T={};a&&a.data&&this.setData(a.data)},properties:{getData:e("T"),setData:function(a){this.T=this.a.innerHTML=a},$:function(a){return this.a.querySelector(a)},$$:function(a){return la(a,this.a)}}});
}());
