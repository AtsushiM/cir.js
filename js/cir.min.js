...
c&&(0<b.y?d.bottom=!0:0>b.y&&(d.top=!0),d.change=!0);a.callback(d)}})},bind:function(a){function b(a,b,d){var f=function(a){a=c._t(a);d(a)};m(a,b,f);this._dispose.push([a,b,f])}var c=this,d=a.element,f=a.start||q,e=a.move||q,k=a.end||q,h=!1,j=0,g=0;a.direction&&c.direction({element:d,boundary:a.boundary,callback:a.direction});b(d,l.switchdown,function(a){h=!0;j=a.pageX;g=a.pageY;f({e:a,move:{x:j,y:g}})});b(p,l.switchmove,function(a){h&&e({e:a,move:{x:a.pageX-j,y:a.pageY-g}})});b(p,l.switchup,function(a){h&&
