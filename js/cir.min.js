...
!1;this.waitid=null},properties:{request:function(a){if(this.locked)return!1;this.callback(a);this.lock();this.waitid=setTimeout(this.unlock,this.waittime,this)},lock:function(){this.locked=!0},unlock:function(a){a=a||this;a.locked=!1;clearInterval(a.waitid)}}});d.Timer=function(a){function b(){m=Date.now();var a=f-(m-l)/1E3;0>a&&(a=0);p=c(a);i(p);if(m>o)return r.stop(),k(),!0;q=setTimeout(b,j);return!1}function c(a){var b;b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({num:a,digit:n.integer});b=d({num:b,
digit:n.few,isFew:!0});return a+"."+b}function d(a){var b=""+a.num,c=a.digit,e=c-b.length;return!a.isFew?-1<e?g(e,0)+b:g(c,9):0<e?b+g(e,0):b.slice(0,c)}function g(a,b){for(var c="",b=""+b;0<a;)c+=b,a--;return c}var f=a.limit,h=1E3*f,j=1E3*a.interval,i=a.onupdate,k=a.ontimeup,n=function(a){a=a.split(".");return{integer:a[0].length,few:a[1].length}}(a.template),l=0,m=0,o=h,p=c(f),q,r={getLimit:function(){return f},getTime:function(){return p},getProgress:function(){return 1-(o-m)/h},setUpdate:function(a){i=
a},setTimeup:function(a){k=a},countDown:function(){m=l=Date.now();o=l+h;b()},stop:function(){clearInterval(q)}};return r};d.Tweener=d.klass({init:function(a,b,c){var e,c=c||{};this.target=a;this.property=[];for(e in b)a=b[e],a.name=e,a.distance=a.to-a.from,a.prefix=a.prefix||"",a.suffix=a.suffix||"px",this.property.push(a);this.duration=c.duration||d.Tweener.Duration;this.easing=c.easing||this._easing;this.onComplete=c.onComplete;this.begin=Date.now();d.Tweener.Items.push(this);d.Tweener.timerId||
this.start()},properties:{_easing:function(a,b,c,d){return c*a/d+b},_requestAnimationFrame:function(){var a=d.utility.win;return a.requestAnimationFrame?function(a){requestAnimationFrame(a)}:a.webkitRequestAnimationFrame?function(a){webkitRequestAnimationFrame(a)}:a.mozRequestAnimationFrame?function(a){mozRequestAnimationFrame(a)}:a.oRequestAnimationFrame?function(a){oRequestAnimationFrame(a)}:a.msRequestAnimationFrame?function(a){msRequestAnimationFrame(a)}:function(a){setTimeout(a,1E3/d.Tweener.FPS)}}(),
loop:function(){for(var a=this,b=d.Tweener.Items,c,e=Date.now(),g,f=b.length,h,j,i;f--;)if(c=b[f],j=c.property.length,g=e-c.begin,g<c.duration)for(h=0;h<j;h++)i=c.property[h],d.Tweener._setProp(c.target,i,c.easing(g,i.from,i.distance,c.duration));else{for(h=0;h<j;h++)i=c.property[h],d.Tweener._setProp(c.target,i,i.to);if(c.onComplete)c.onComplete();b.splice(f,1)}if(b.length)return a._requestAnimationFrame(function(){a.loop()}),!0;this.end()},start:function(){var a=this;d.Tweener.timerId=1;a._requestAnimationFrame(function(){a.loop()})},
end:function(){d.Tweener.Items=[];clearInterval(d.Tweener.timerId);d.Tweener.timerId=null}}});d.Tweener._setProp=function(a,b,c){a[b.name]=b.prefix+c+b.suffix};d.Tweener.timerId=null;d.Tweener.Items=[];d.Tweener.FPS=30;d.Tweener.Duration=500;d.Twitter=d.klass({properties:{utility:d.utility,shareURLBase:"https://twitter.com/intent/tweet?",getShareURL:function(a){var b=a.redirect_uri,c=a.caption||"",d=a.name||"",a=a.hash||"",g=this.shareURLBase;return g+=this.utility.makeQueryString({url:b,text:c+(d?
