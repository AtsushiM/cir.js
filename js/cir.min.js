...
e.styleElement,arguments)},html:function(){return b(this,e.innerHTML,arguments)},attr:function(){return b(this,e.attrElement,arguments)},append:function(){return a(this,e.appendElement,arguments)}}})();(function(){function a(a,e,j,i,k){c.isFunction(j)&&(k=j,j=null);c.isFunction(i)&&(k=i,i=null);var n=d.Tweener,l=a.style,m,a=c.computedStyleElement(a),o,p={};for(m in e)o=b(e[m]),p[m]={from:1*b(a.getPropertyValue(m))[1]||0,to:1*o[1]||0,suffix:o[2]};new n(l,p,{duration:j,easing:g[i],onComplete:k})}function b(a){return(""+
...
this._event.load,e,!1);this.utility.onEvent(this.utility.win,this._event.orientationchange,e,!1)},orientationCheck:function(){return 90!==Math.abs(this.utility.win.orientation)&&this.utility.win.innerWidth<this.utility.win.innerHeight?{portrait:!0,landscape:!1}:{portrait:!1,landscape:!0}},orientationChange:function(a){function b(a,c){a(d.utility.win,d._event.load,c);a(d.utility.win,d._event.orientationchange,c);a(d.utility.win,d._event.resize,c)}function c(){e();b(d.utility.offEvent,c)}function e(){if(d.orientationCheck().portrait)return a.portrait(),
!0;a.landscape()}var d=this;a.immediately&&e();if(a.one)return b(d.utility.onEvent,c),function(){b(d.utility.offEvent,c)};b(d.utility.onEvent,e);return function(){b(d.utility.offEvent,e)}}}})})();d.NumberImage=d.klass({init:function(a){a=a||{type:""};this.type=a.type},properties:{make:function(a){var a=(""+a).split(""),b="",c;for(c=a.length;c--;)b='<span class="num_'+(this.type+a[c])+'">&nbsp;</span>'+b;return b}}});d.Observer=d.klass({init:function(a){a=a||{single:!1};if(a.single&&d.Observer.instance)return d.Observer.instance;
this.observed={};a.single&&(d.Observer.instance=this)},properties:{getObserved:function(){return this.observed},on:function(a,b){var c=this.observed;c[a]||(c[a]=[]);c[a].push(b)},one:function(a,b){var c=this,d=function(g){b(g);c.off(a,d)};c.on(a,d)},off:function(a,b){var c=this.observed;if(!b)return delete c[a],!0;var d=c[a],g;if(!d)return!1;for(g=d.length;g--;)if(b===d[g])return d.splice(g,1),0===d.length&&delete c[a],!0;return!1},fire:function(a,b){var c=this.observed[a],d,g;if(!c)return!1;for(g=
c.length;g--;)(d=c[g])&&d(b);return!0}}});d.Observer.instance=null;d.PreRender=d.klass({init:function(a){a=a||{};a.loopblur||(a.loopblur=20);this.elements=a.elements||[];this.guesslimit=a.guesslimit||30;this.onrendered=a.onrendered||this.utility.nullFunction;this.looptime=a.looptime||100;this.loopblur=this.looptime+a.loopblur;this.loopid=this.prevtime=null},properties:{utility:d.utility,start:function(){var a;for(a=this.elements.length;a--;)this.utility.showElement(this.elements[a]);this.prevtime=
Date.now();this.loopid=setInterval(function(a){var c=Date.now(),d=c-a.prevtime;a.prevtime=c;if(d<a.loopblur&&(a.guesslimit--,1>a.guesslimit)){clearInterval(a.loopid);for(c=a.elements.length;c--;)a.utility.hideElement(a.elements[c]);a.onrendered()}},this.looptime,this)}}});d.ScriptLoad=d.klass({properties:{utility:d.utility,_event:new d.Event,requests:function(a){for(var b=0,c=a.length;b<c;b++)this.request(a[b])},request:function(a){var b=this.utility.makeElement("script");b.type="text/javascript";
b.src=a.src;this.utility.body.appendChild(b);if(a.callback)this.utility.onEvent(b,this._event.load,a.callback)}}});(function(){function a(a){return e?c.getResponseHeader(a):!1}function b(a){var b=new XMLHttpRequest;b.onload=function(){a(b)};b.open("HEAD",location.href+"?update"+Date.now()+"=1");b.send(null);return b}var c,e=!1;d.ServerMeta=d.klass({init:function(a){var a=a||{},d=a.callback||this.utility.nullFunction;c?d(c):c=b(function(){e=!0;d(c)})},properties:{utility:d.utility,date:function(a){return b(function(b){b=
