// cir.js v0.15.3 | (c) 2013 Atsushi Mizoue.
(function(){
...
b){var c,d;for(c in b)if(d=c.match(/^on(.+)$/))a.on(d[1],E(a,b[c]))}function ka(){this.stop();this._super()}function H(){return Date.now()}function ca(a){h.scrollTo(0,a)}function qa(){ca(1)}function T(a,b,c){for(c in b)a[c]=b[c];return a}function ra(a,b){b=n+a;return b.match(/^{.*}$/)?ba(b):b.match(/^[0-9\.]+$/)?+b:"true"===b?k:"false"===b?f:a}function la(a){var b=[];b.push.apply(b,a);return b}function v(a,b,c){return a.split(b).join(c)}function Da(a){return v(v(v(v(v(a,"&","&amp;"),'"',"&quot;"),
"'","&#039;"),"<","&lt;"),">","&gt;")}function ma(a,b,c,d){b=c=n;for(d in a)a[d]&&(c+=b+d+"="+encodeURIComponent(a[d]),b="&");return c}function P(a,b){return Object.prototype.toString.call(b)=="[object "+a+"]"?k:f}function na(a){return P("Object",a)}function K(a){return P("Number",a)}function sa(a){return P("String",a)}function Q(a){return P("Function",a)}function ta(a){return P("Boolean",a)}function U(a){return P("Array",a)}function L(a){return a===ja?f:k}function Ea(){return"ontouchstart"in h}function t(){}
function ua(){throw Error("abstract-function was executed without being implemented.");}function va(a){a.preventDefault();return f}function da(a,b){b=b||navigator.userAgent;return!!b.match(a)}function E(a,b){return function(){return b.apply(a,arguments)}}function oa(a,b,c,d){b=b||a;c=c||b;for(d in b)Q(b[d])&&(c[d]=E(a,b[d]));T(a,c);return c}function wa(a,b,c,d){for(var e;k;){e=~~((a+b)/2);if(a==e)return d(e);c(e)?a=e:b=e}}function Fa(a){return a.toString().match(/^\s*function.*\((.+)\)/)}function V(a){return U(a)?
...
c==n?a.setAttribute(b,c):a.getAttribute(b)}function Ha(a,b){a.removeAttribute(b)}function w(a,b,c){c=p.createElement(a);b&&ea(c,b);return c}function Ia(a){var b=w("div");M(b,a);return la(b.children)}function F(a,b,c){a.addEventListener(b,c,f)}function G(a,b,c){a.removeEventListener(b,c,f)}function Ja(a,b,c,d){function e(a){var c=a.target;W(c,b)&&d.apply(c,arguments)}F(a,c,e);return e}function fa(a){a.style.display="block"}function ga(a){a.style.display="none"}function x(a,b,c,d,e,g){c=a.style;for(d in b)e=
d,g=b[d],K(g)&&(g+="px"),c[e]=g}function ha(a){return p.defaultView.getComputedStyle(a,u)}function Z(a){return a.parentNode}function N(a,b){return a.appendChild(b)}function Ka(a,b){return Z(a).insertBefore(b,a)}function La(a,b){return Z(a).insertBefore(b,a.nextSibling)}function Ma(a,b){return a.insertBefore(b,a.firstChild)}function $(a){return Z(a).removeChild(a)}function M(a,b){if(!L(b))return a.innerHTML;a.innerHTML=b}function Na(a,b){if(!L(b))return a.value;a.value=b}function s(a,b,c){a=a||C.lass;
a=a.extend(b);L(c)&&(a.support=c);return a}function l(a,b){return s(C.Base,a,b)}function Oa(){}function B(a,b,c){var d=a.length;for(c=Pa(c);d--;)c[0]=a[d],b.apply(a,c);return a}function R(a,b,c){c=Pa(c);c[0]=a[0];return b.apply(u,c)}function Pa(a){var b=[u];b.push.apply(b,a);return b}function Qa(a){var b=w(a.type);b.controls=a.controls?k:f;b.preload=a.preload||"auto";b.autoplay=a.autoplay?k:f;b.loop=a.loop?k:f;b.src=a.dir+a.name+"."+a.suffix[0][0];return b}function Ra(a,b){if(!h["HTML"+a+"Element"])return f;
a=a.toLowerCase();for(var c=w(a),d=[],e=0,g=b.length;e<g;e++)c.canPlayType(a+"/"+b[e][1])&&d.push(b[e]);return d.length?d:f}C={};var h=window,p=document,k=!0,f=!1,u=null,n="",D={},ja=void 0,y=Ea(),Sa=m("0.19,1,0.22,1"),I=1.70158,q,Ta,xa,Ua,Va,ya,z,za,Wa,ia;Date.now||(Date.now=function(){return+new Date});C.util={pageTop:qa,override:T,replaceAll:v,template:function(a,b,c,d){for(c in b)d=b[c],a=v(v(a,"<%= "+c+" %>",Da(d)),"<%- "+c+" %>",d);return a},escape:Da,unescape:function(a){return v(v(v(v(v(a,
...
isTouchable:Ea,nullFunction:t,abstraceFunction:ua,eventPrevent:va,eventStop:function(a){a.stopPropagation();return f},checkUserAgent:da,proxy:E,owner:oa,binarySearch:function(a){a=a||D;return wa(a.low||0,a.high||0,a.compare||t,a.end||t)},toArray:la,copyArray:V,hasDeclaredArgument:Fa};C.dom={win:h,doc:p,$:Ca,$$:function(a){return pa(a,p)},$child:function(a,b){return b.querySelector(a)},$$child:pa,$id:function(a){return p.getElementById(a)},on:F,off:G,delegate:Ja,create:w,show:fa,hide:ga,hasClass:W,
...
outBack:[m("0.175,0.885,0.32,1"),m("0.175,0.885,0.32,1.275")],inOutBack:[m("0.68,0,0.265,1"),m("0.68,-0.55,0.265,1.55")]};(function(){var a=Ba(["animation","webkitAnimation"],"Animation"),b=a.prefix,c=a.gb,d=a.ib,e=a.sheet,g=C.SSAnime=s(C.Observer,{Ta:function(){var a=this.b,b=this.wb;G(a,d+"End",b);G(a,"animationend",b)},init:function(a,b,d,f){f=this;f._super();O(f,d);d=d||D;f.qa=d.oncomplete||t;f.b=a;g.id++;f.q="ciranim"+g.id;a=d.duration||g.duration;var k=d.ease||Sa,h,l={};for(h in b)l[h]=b[h],
...
a.q);x(c,a.Ob)}a.fire("complete",d)}a=this;c=a.b;a.fire("start");a.wb=g;F(c,d+"End",g);F(c,"animationend",g);X(c,a.q)},stop:function(){var a={};this.fire("stop");a[c+"animation-play-state"]="paused";x(this.b,a);this.Ta()}},a.kb);g.id=0;g.duration=500})();(function(){var a=Ba(["transitionProperty","webkitTransitionProperty"],"Transition"),b=a.gb,c=a.ib,d=a.sheet,e;e=C.SSTrans=s(C.Observer,{init:function(a,c,r,f){f=this;f._super();O(f,r);r=r||D;e.id++;f.q="cirtrans"+e.id;var h=[];T({},c);var k,l=r.duration||
e.duration,m=r.ease||Sa;U(m)||(m=[m]);for(k in c)h.push(k);k=0;for(var p=m.length,q=n,q=q+(b+"transition-property:"+h.join(" ")+";"+b+"transition-duration:"+l+"ms;");k<p;k++)q+=b+"transition-timing-function:"+m[k]+";";d.insertRule("."+f.q+"{"+q+"}",d.cssRules.length);f.b=a;f.P=c;r.manual||f.start()},dispose:ka,start:function(a){a=this;a.fire("start");a.da=function(b){a.V();setTimeout(function(){a.La||a.fire("complete",b)},1)};F(a.b,c+"End",a.da);F(a.b,"transitionend",a.da);X(a.b,a.q);x(a.b,a.P)},
V:function(a){a=this;var b=d.cssRules,e=b.length,f;G(a.b,c+"End",a.da);G(a.b,"transitionend",a.da);for(Y(a.b,a.q);e--;)if(f=b[e].name||(n+b[e].selectorText).split(".")[1],f==a.q){d.deleteRule(e);break}},La:f,stop:function(){this.La=k;this.fire("stop");this.V()}},a.kb);e.id=0;e.duration=500})();var Aa={request:function(a){return this.nb.call(h,a)},cancel:function(a){return this.qb.call(h,a)}};(function(){var a=["webkit","moz","o","ms"],b,c,d;if(h.requestAnimationFrame)c=h.requestAnimationFrame,d=h.cancelAnimationFrame;
else{for(b=a.length;b--;)if(h[a[b]+"RequestAnimationFrame"]){c=h[a[b]+"RequestAnimationFrame"];d=h[a[b]+"CancelAnimationFrame"];break}c||(c=function(a){return setTimeout(a,1E3/C.AnimeFrame.fps)},d=function(a){clearTimeout(a)})}Aa.nb=c;Aa.qb=d})();C.AnimeFrame=l(Aa);C.AnimeFrame.fps=30;C.animeframe=new C.AnimeFrame;z=C.Tweener=s(C.Observer,{init:function(a,b,c,d,e,g){g=this;g._super();O(g,c);c=c||D;g.cb=a;g.P=[];for(d in b)e=b[d],e.name=d,e.Kb=e.to-e.from,e.prefix=e.prefix||n,e.suffix=e.suffix||(e.suffix===
n?n:"px"),g.P.push(e);g.Ga=c.duration||z.duration;g.vb=c.ease||g.lb;c.manual||g.start()},dispose:ka,lb:function(a,b,c,d){return c*(-Math.pow(2,-10*a/d)+1)+b},U:function(){for(var a=this,b=z.ja,c,d=H(),e,g=b.length,f,r;g--;)if(c=b[g],f=c.P.length,e=d-c.Ib,e<c.Ga)for(;f--;)r=c.P[f],z.Ya(c.cb,r,c.vb(e,r.from,r.Kb,c.Ga));else{for(;f--;)r=c.P[f],z.Ya(c.cb,r,r.to);c.fire("complete");b.splice(g,1)}b.length?C.animeframe.request(function(){a.U()}):a.V()},start:function(a){a=this;a.fire("start");a.Ib=H();z.ja.push(a);
z.Ba||(z.Ba=1,C.animeframe.request(function(){a.U&&a.U()}))},V:function(){z.ja=[];C.animeframe.cancel(z.Ba);z.Ba=u},stop:function(){this.fire("stop");this.V()}});z.Ya=function(a,b,c){a[b.name]=b.prefix||b.suffix?b.prefix+c+b.suffix:c};z.ja=[];z.duration=500;C.$=function(a,b,c,d,e){c="string"==typeof a?(b||p).querySelectorAll(a):[a];d=new Oa;for(e=d.length=c.length;e--;)d[e]=c[e];return d};ia=C.$.Sb={querySelectorAll:function(a){return this[0].querySelectorAll(a)},find:function(a){return C.$(a,this)},
parent:function(){return C.$(Z(this[0]))},on:function(){return B(this,F,arguments)},off:function(){return B(this,G,arguments)},delegate:function(a,b,c){var d;this.na||(this.na={});d=this.na;d[b]||(d[b]={});d=d[b];d[a]||(d[a]=[]);d=d[a];return B(this,function(){var a=Ja.apply(u,arguments);d.push([c,a])},arguments)},undelegate:function(a,b,c){var d=this.na;if(!d)return f;d=d[b];if(!d)return f;d=d[a];if(!d)return f;a=d.length;if(c){for(;a--;)if(d[a][0]===c)return this.off(b,d[a][1]),d.splice(a,1),k;
...
removeAttr:function(){return B(this,Ha,arguments)},append:function(){return B(this,N,arguments)},before:function(){return R(this,Ka,arguments)},after:function(){return R(this,La,arguments)},insertBefore:function(){return R(this,Ma,arguments)},remove:function(){return B(this,$,arguments)}};(function(){function a(a,g,f,r,h){Q(f)&&(h=f,f=u);Q(r)&&!h&&(h=r,r=u);r&&(r=d[r]);f={duration:f,ease:r,oncomplete:h};if(c)g=new b(a,g,f);else{r=C.Tweener;h=a.style;var k;a=ha(a);var l,m,n={};for(k in g)l=J(g[k]),
m=a.getPropertyValue(k),m=!m||"none"==m?0:+J(m)[2],n[k]={from:m,to:+l[2]||0,prefix:l[1],suffix:l[3]};g=new r(h,n,f)}this.L.push(g)}var b=C.SSAnime||{},c=b.support,d={};c&&C.cssease?d=C.cssease:C.ease&&(d=C.ease);ia.animate=function(){this.L||(this.L=[]);return B(this,a,arguments)};ia.stop=function(a,b){a=this;if(a.L){for(b=a.L.length;b--;)a.L[b].stop();a.L=u}return a}})();C.HashQuery=l({typeCast:function(a){var b=ra(a);return a==b&&(a=a.match("^[\"'](.*)[\"']$"))?a[1]:b},makeHash:function(a){var b=
...
a.oncomplete,c=a.onerror;b&&(a.oncomplete=function(a){b(ba(a))});c&&(a.onerror=function(a){c(a)})}});Ta=C.Progress=l({ia:0,oa:0,K:0,p:function(a,b,c){b=this;L(a)&&b.w.push(a);b.K=b.ia/b.za;1<b.K&&(b.K=1);b.Ua(b.K);b.oa&&(c=Error("miss"));if(b.ia==b.za||b.oa)b.qa(c,b.w),b.qa=b.Ua=t},init:function(a,b,c){b=this;c=a.waits;U(c)&&(c=c.length);b.za=c;b.qa=a.oncomplete;b.Ua=a.onprogress||t;b.w=[]},getProgress:aa("K"),pass:function(a){this.ia++;this.p(a)},miss:function(a){this.oa++;this.p(a)},exit:function(a,
b){b=this;b.ia=b.za;b.p(a)}});y=s(C.Observer,{init:function(a){this._super();a=a||D;var b=V(a.queue)||[];O(this,a);this.resetQueue(b);this.J=E(this,this.J)},start:function(){this.fire("start");this.O=f;this.Ha()},restart:function(a){this.resetQueue(a);this.start()},stop:function(){this.k=u;this.fire("stop")},pause:function(){this.O=k;this.fire("pause")},resume:function(){this.O&&(this.fire("resume"),this.O=f,this.Ha())},resetQueue:function(a){a&&(this.Cb=V(a));a=this.k=V(this.Cb);for(var b in a)a[b].resetQueue&&
a[b].resetQueue();this.fire("reset")},setQueue:function(a){this.k=V(a);this.fire("change",this.getQueue())},getQueue:function(){return V(this.k)},addTask:function(a,b){if(!K(b)||b>this.k.length)b=this.k.length;this.k.splice(b,0,a);this.fire("change",this.getQueue())},removeTask:function(a){for(var b=0,c=this.k.length;b<c;b++)if(this.k[b]===a){this.k.splice(b,1);this.fire("change",this.getQueue());break}},ea:ua,Ha:function(){this.O||this.ea()},Ca:function(a){var b=this;return a.one&&a.start?(a.one("complete",
E(b,b.J)),E(a,a.start)):Fa(a)?E(b,a):function(c){a.call(b);c()}},J:ua});C.Parallel=C.Async=s(y,{ea:function(){if(this.k){if(0===this.k.length)return this.fire("complete");for(this.Wa=this.k.length;!this.O&&this.k&&this.k[0];)this.Ca(this.k.shift())(this.J)}},J:function(){this.fire("progress");this.Wa--;0==this.Wa&&this.fire("complete")}});C.Serial=C.Sync=s(y,{ea:function(){if(this.k&&!this.O){if(this.k[0])return this.Ca(this.k.shift())(this.J);this.fire("complete")}},J:function(){this.fire("progress");
this.ea()}});C.Anvas=l({init:function(a,b){b=this;b.Z=a.canvas;b.rb=b.Z.getContext("2d");b.setSize(a)},setSize:function(a){a.width&&(this.Z.width=a.width);a.height&&(this.Z.height=a.height)},pigment:function(a){var b=this,c=w("canvas"),d=w("img");d.onload=function(){c.width=a.width;c.height=a.height;c.getContext("2d").drawImage(d,0,0);a.onload.apply(b,[c,d])};d.src=a.src;return{image:c,x:a.x||0,y:a.y||0}},pigments:function(a,b){function c(a){var c=a.onload||t;a.onload=function(a,e){c(a,e);g--;0==
g&&b.call(d,f)};f[e]=d.pigment(a);g++}var d=this,e,g=0,f={};b=b||t;for(e in a)c(a[e]);return f},draw:function(a){var b=0,c=a.length,d=this.rb,e=this.Z;for(d.clearRect(0,0,e.width,e.height);b<c;b++)(e=a[b])&&d.drawImage(e.image,e.x,e.y)}},!!h.HTMLCanvasElement);(function(){function a(a){a=+a;10>a&&(a="0"+a);return""+a}var b="Sun Mon Tue Wed Thu Fri Sat".split(" "),c="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),d="January February March April May June July August September October November December".split(" "),
e="Jan Feb Mar Apr May June July Aug Sep Oct Nov Dec".split(" "),g={d:function(b){return a(g.j(b))},j:function(a){return a.getDate()},D:function(a){return b[a.getDay()]},l:function(a){return c[a.getDay()]},F:function(a){return d[a.getMonth()]},M:function(a){return e[a.getMonth()]},m:function(b){return a(g.n(b))},n:function(a){return a.getMonth()+1},Y:function(a){return a.getFullYear()},y:function(a){a=g.Y(a);a=""+a;return a.slice(a.length-2)},a:function(a){return g.A(a).toLowerCase()},A:function(a){return 12>
g.G(a)?"AM":"PM"},g:function(a){a=g.G(a);return 12==a||0==a||24==a?12:a%12},G:function(a){return a.getHours()},h:function(b){return a(g.g(b))},H:function(b){return a(g.G(b))},i:function(b){return a(g.I(b))},s:function(b){return a(g.S(b))},I:function(a){return a.getMinutes()},S:function(a){return a.getSeconds()}},f=/%([djDlFMmnYyaAgGhHisIS])/g;C.DateFactory=l({make:function(a){switch(k){case sa(a):return a=a.split(/[T:\-\+\/\s]/),new Date(+a[0],a[1]-1,+a[2],+a[3]||0,+a[4]||0,+a[5]||0);case K(a):return new Date(a);
case P("Date",a):return a}return new Date},format:function(a,b){b=this.make(b);return a.replace(f,function(a,c){return g[c](b)})}})})();C.Rollover=l({init:function(a,b){b=this;var c=a.toggleClass||n,d=a.over||t,e=a.out||t;b.u=a.els;b.Eb=function(){X(b,c);d()};b.bb=function(){Y(b,c);e()};a.manual||b.attach()},dispose:function(){this.detach();this._super()},attach:function(){this.R(F)},detach:function(){this.R(G)},R:function(a,b,c){b=this;for(c=b.u.length;c--;)a(b.u[c],q.SWITCHOVER,b.Eb),a(b.u[c],q.SWITCHOUT,
b.bb),a(b.u[c],q.MOUSEOUT,b.bb)}});C.DataStore=l({aa:function(){return!this.W?{}:[]},init:function(a){a=a||D;this.W=a.array||f;this.reset()},set:function(a,b){var c;"object"!==typeof a&&(c={},c[a]=b,a=c);for(c in a)this.ba[c]=a[c]},get:function(a){var b=this.aa(),c=this.ba,d;if(a)return c[a];for(d in c)b[d]=c[d];return b},remove:function(a){L(this.ba[a])&&(this.W?this.data.splice(a,1):delete this.ba[a])},reset:function(){this.ba=this.aa()}});za=l({aa:function(){return!this.W?{}:[]},init:function(a){this.W=
a.array||f;this.N=a.namespace?a.namespace+"-":n;this.Q=h[a.type+"Storage"]},set:function(a,b){var c;"object"!==typeof a&&(c={},c[a]=b,a=c);for(c in a)this.Q.setItem(this.N+c,JSON.stringify(a[c]))},get:function(a,b){b=this;var c=this.aa(),d,e=b.Q;if(a)return ba(e.getItem(b.N+a));for(d in e)b.N?(a=d.split(b.N)[1])&&(c[a]=ba(e[d])):c[d]=ba(e[d]);return c},remove:function(a,b){b=this;a=b.N+a;L(b.Q.getItem(a))&&b.Q.removeItem(a)},reset:function(a,b){a=this;if(!a.N)return a.Q.clear();for(b in a.Q)a.remove(b)}});
C.LocalStorage=function(a){a=a||{};a.type="local";return new za(a)};C.SessionStorage=function(a){a=a||{};a.type="session";return new za(a)};C.DragFlick=l({wa:function(a){return a.changedTouches?a.changedTouches[0]:a},mb:function(a){var b=this,c,d,e=f;b.f.push(b.contract(a.el,q.SWITCHDOWN,function(a){var f=b.wa(a);c=f.pageX;d=f.pageY;e=k;va(a)}),b.contract(h,q.SWITCHUP,function(g){e&&(g=b.wa(g),a.callback({x:g.pageX-c,y:g.pageY-d}),e=f)}))},tb:function(a){this.mb({el:a.el,callback:function(b){var c=
a.boundary||0,d={change:f,top:f,right:f,bottom:f,left:f,amount:b};Math.abs(b.x)>c&&(0<b.x?d.right=k:0>b.x&&(d.left=k),d.change=k);Math.abs(b.y)>c&&(0<b.y?d.bottom=k:0>b.y&&(d.top=k),d.change=k);a.callback(d)}})},init:function(a,b){b=this;b.f=[];a=(b.c=a)||D;a.manual||b.attach()},attach:function(){function a(a,c,d){b.f.push(b.contract(a,c,function(a){d(b.wa(a))}))}var b=this,c=this.c,d=c.el,e=c.start||t,g=c.move||t,h=c.end||t,l=f,m=0,n=0;c.direction&&b.tb({el:d,boundary:c.boundary,callback:c.direction});
a(d,q.SWITCHDOWN,function(a){l=k;m=a.pageX;n=a.pageY;e({e:a,move:{x:m,y:n}})});a(p,q.SWITCHMOVE,function(a){l&&g({e:a,move:{x:a.pageX-m,y:a.pageY-n}})});a(p,q.SWITCHUP,function(a){l&&(h({e:a,move:{x:a.pageX-m,y:a.pageY-n}}),l=f)})},detach:function(a){a=this;for(var b=a.f,c=b.length;c--;)a.uncontract(b[c]);a.f=[]}});C.ExternalInterface=function(a){a=a||D;return a.android?new Ua(a):new Va};Ua=s(C.HashQuery,{init:function(a){this.c=a},call:function(a){this.c.android[a.mode](this.makeHash(a))},addCallback:function(a,
b,c){c=this;c.c.externalObj[a]=function(a){b(c.parseHash(a).vars)}},removeCallback:function(a){delete this.c.externalObj[a]}});Va=s(C.HashQuery,{init:function(){this.T={}},dispose:function(a){for(a in this.T)this.removeCallback(a);this._super()},call:function(a){this.setHash(a)},addCallback:function(a,b,c){c=this;c.T[a]=function(d){d=c.getHash();d.mode==a&&b(d.vars)};F(h,"hashchange",c.T[a])},removeCallback:function(a){G(h,"hashchange",this.T[a]);delete this.T[a]}});C.Facebook=l({shareURL:function(a){return"https://www.facebook.com/dialog/feed?app_id="+
a.app_id+"&redirect_uri="+a.redirect_uri+ma({link:a.link,picture:a.picture,name:a.name,caption:a.caption,description:a.description})}});C.FPS=l({sa:0,Bb:0,v:0,init:function(a,b){b=this;b.ma=b.va=a.criterion;b.Sa=b.Ia(b.ma);b.xb=a.enterframe;a.manual||b.start()},dispose:ka,getCriterion:aa("ma"),getSurver:aa("va"),getFrameTime:aa("Sa"),enter:function(a){a=this;a.xb({criterion:a.ma,surver:a.va})},start:function(a){a=this;a.sa=H();a.v=setInterval(a.U,a.Sa,a)},U:function(a,b){b=a.Bb=H();a.va=a.Ia(b-a.sa);
a.sa=b;a.enter()},Ia:function(a){return Math.round(1E3/a)},stop:function(){clearInterval(this.v)}});y=s(C.Observer,{xa:"",init:function(a,b){this._super(a);b=this;b.ua=a.srcs;b.Na=[];b.f=[];b.K=new Ta({waits:b.ua,onprogress:function(a){b.fire("progress",a)},oncomplete:function(){for(var a=b.f.length;a--;)b.uncontract(b.f[a]);b.f=[];b.fire("complete",b.Na)}});O(b,a);a.manual||b.start()},start:function(){function a(){b.K.pass()}var b=this,c,d=0,e=b.ua.length;this.fire("start");if(!b.Db)for(b.Db=k;d<
e;d++)c=w(b.xa),c.src=b.ua[d],b.f.push(b.contract(c,q.LOAD,a)),b.Na.push(c),b.Oa(c)},Oa:t});C.ImgLoad=s(y,{xa:"img"});C.ScriptLoad=s(y,{xa:"script",Oa:function(a){N(p.body,a)}});(function(){function a(){b=k;G(h,q.LOAD,a)}var b=f;F(h,q.LOAD,a);C.WindowLoad=s(C.Observer,{init:function(a){this._super();O(this,a);a.manual||this.start()},start:function(){var a=this;a.fire("start");if(!a.Pb)if(a.Pb=k,b)a.fire("complete");else var d=a.contract(h,q.LOAD,function(){a.uncontract(d);a.fire("complete")})}})})();
...
h.pageYOffset;return a!==ja?a:(p.documentElement||p.body.parentNode||p.body).scrollTop},smooth:function(a,b,c,d){c=this;b=b||t;c.ab||(c.ab=k,K(a)||(a=a.offsetTop),d=p.height-h.innerHeight,a>d&&(a=d),c.Da=c.scrollY(),c.$a=setInterval(function(d){d=c.scrollY();d=0.3*(a-d)+d;if(1>Math.abs(a-d)||c.Da==d)return ca(a),clearInterval(c.$a),b(a),delete c.ab;c.Da=d;ca(d)},50))},kill:function(a){a=this;a.fa||(x(p.body,{overflow:"hidden"}),a.fa=a.contract(p,q.TOUCHMOVE,va))},revival:function(a){a=this;a.fa&&
(x(p.body,{overflow:"auto"}),a.uncontract(a.fa),delete a.fa)}});C.LimitText=l({Ra:8,ka:function(a){M(this.C,a);N(Z(this.b),this.C)},la:function(){M(this.C,n);$(this.C)},init:function(a){var b=this.b=a.el;ha(b);var b=this.C=w(b.tagName,{"class":ea(b,"class"),style:ea(b,"style")}),c=this.Fa=ha(b);this.fb=a.width;this.Ka=a.height;this.ka(0);L(a.width)||(this.fb=+J(c.width)[2]);L(a.height)||(this.Ka=+J(c.height)[2]);x(b,{height:"auto"});this.yb=+J(c.fontSize)[2];this.la()},ga:function(){return+J(this.Fa.width)[2]<=
this.fb&&+J(this.Fa.height)[2]<=this.Ka?k:f},getLimitFontSize:function(a){a=n+a;var b=this,c=b.yb,d;x(b.C,{fontSize:c});b.ka(a);b.ga()?d=c:wa(b.Ra-1,c,function(a){x(b.C,{fontSize:a});return b.ga()},function(a){d=a});b.la();d<b.Ra&&(d=0);return d},getLimitTextLength:function(a){a=n+a;var b=this,c=a.length,d;b.ka(a);b.ga()?d=c:wa(0,c,function(c){M(b.C,a.slice(0,c));return b.ga()},function(a){d=a});b.la();return d}});ia&&(Oa.prototype=ia)})();
})();
