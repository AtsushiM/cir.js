/*! cir.js v0.8.11 | (c) 2013 Atsushi Mizoue. */(function(){
...
function Ga(a){var b=k(a.type);b.controls=a.controls?q:l;b.preload=a.preload||"auto";b.autoplay=a.autoplay?q:l;b.loop=a.loop?q:l;b.src=a.dir+a.name+"."+a.suffix[0][0];return b}function Ha(a,b){if(!u["HTML"+a+"Element"])return l;a=a.toLowerCase();for(var c=k(a),d=[],e=0,f=b.length;e<f;e++)c.canPlayType(a+"/"+b[e][1])&&d.push(b[e]);return d.length?d:l}var u=window,F=document,q=!0,l=!1,O=null,m="",R={},n=void 0,S=oa(),T,Ia=j("0.19,1,0.22,1"),U=1.70158,Ja,Ka,Oa,Qa,V,Ra,Sa,Ta;C={};
...
C.$.za={querySelectorAll:function(a){return this[0].querySelectorAll(a)},find:function(a){return C.$(a,this)},parent:function(){return C.$(xa(this[0]))},on:function(){return Q(this,J,arguments)},off:function(){return Q(this,L,arguments)},show:function(){return Q(this,M)},hide:function(){return Q(this,va)},hasClass:function(){return Fa(this,G,arguments)},addClass:function(){return Q(this,H,arguments)},removeClass:function(){return Q(this,I,arguments)},toggleClass:function(){return Q(this,sa,arguments)},
...
b,l)}});C.mobile=new Sa;var ib=u.navigator.userAgent.toLowerCase(),Z;Z=-1!=ib.indexOf("opera")?"opera":-1!=ib.indexOf("msie")?"ie":-1!=ib.indexOf("chrome")?"chrome":-1!=ib.indexOf("safari")?"safari":-1!=ib.indexOf("gecko")?"gecko":"ather";Ta=C.PC=P(n,{isChrome:function(){return"chrome"==Z},isSafari:function(){return"safari"==Z},isGecko:function(){return"gecko"==Z},isOpera:function(){return"opera"==Z},isIE:function(){return"ie"==Z}});C.pc=new Ta;
...
C.DeviceOrientation.support?(jb=C.DeviceOrientation,kb=function(a){return a}):C.DeviceMotion.support&&(jb=C.DeviceMotion,kb=function(a){return a.rotationRate});C.DeviceShake=P(function(a){this.oa=new jb;this.a=a;this.attach()},{Qa:{x:"gamma",y:"beta",z:"alpha"},attach:function(){var a=this,b,c=a.Qa[a.a.direction];a.oa.attach(function(d){d=kb(d);b||(b=d);Math.abs(d[c]-b[c])>a.a.limit&&(b=O,a.a.callback(d),setTimeout(function(){},a.a.waittime))})},detach:function(){this.oa.detach()}});
...
C.Timer=function(a){function b(){ga=v();var a=f-(ga-Ma)/1E3;0>a&&(a=0);Pa=c(a);s(Pa);ga>Na?(lb.stop(),K()):mb=setTimeout(b,p)}function c(a){var b;b=(m+a).split(".");a=b[0];b=b[1]?b[1]:m;a=d({Aa:a,xa:La.Ta});b=d({Aa:b,xa:La.Sa,Ua:q});return a+"."+b}function d(a){var b=m+a.Aa,c=a.xa,d=c-b.length;return!a.Ua?-1<d?e(d,0)+b:e(c,9):0<d?b+e(d,0):b.slice(0,c)}function e(a,b){var c=m;for(b=m+b;0<a;)c+=b,a--;return c}var f=a.limit,g=1E3*f,p=1E3*a.interval,s=a.onupdate,K=a.ontimeup,La;a=a.template.split(".");
La={Ta:a[0].length,Sa:a[1].length};var Ma=0,ga=0,Na=g,Pa=c(f),mb,lb={getLimit:function(){return f},getTime:function(){return Pa},getProgress:function(){return 1-(Na-ga)/g},setUpdate:function(a){s=a},setTimeup:function(a){K=a},countDown:function(){ga=Ma=v();Na=Ma+g;b()},stop:function(){clearInterval(mb)}};return lb};
...
revival:function(){this.D&&(N(F.body,{overflow:"auto"}),this.uncontract(this.D),delete this.D)}});var qb;C.support={};for(qb in C)na(C[qb].support)&&(C.support[qb]=C[qb].support);console.log(C.support);C.beer=function(){console.log("\n   \u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u3000,. -\u2010\uff1d=\uff64\uff64\n\u3000\u3000\u3000\u3000\u3000\u3000 \u3000\u3000\u3000\u3000\u3000\u3000 ,. =\uff1d=\uff64\uff64\u3000\uff4f \u3000 \u25cbo. \u3000i \u3000\u3000 \u3000\u3000 :::\u30c8\uff64\n\u3000\u3000\u3000\u3000\u3000\u3000 \u3000\u3000\u3000\u3000\u3000_,/ \u3000 \u3000 \u3000\uff40\u30fe\u00b4\u00b4`\u30fd\u3001\u3000\uff9f\u3000.\uff4c \u3000 \u3000\u3000 \u3000:::\uff84\uff64\uff3cYEAHHHHHHHHHHHHHHHHHHHH!\n\u3000\u3000\u3000\u3000\u3000 \u3000\u3000\u3000\u3000\u3000 // \u3000\u3000\u3000\u3000 .::::/\u3000\u3000:::::!=\uff1d=l\u3000\u3000\u3000\u3000\u3000 :::|\uff7d.\u3000',\n\u3000 \u3000 \u3000 \u3000 \u3000\u3000 \u3000 /./ \u3000 \u3000 \u3000 .::::/\u3000\u3000 ::::l\u3000\u3000\u3000 |\u3000 __ ..... _::::|} \u30fd l-\uff64\n  \u3000 \u3000 \u3000 \u3000 \u3000 ,\uff68\uff78 ,'..__ \u3000\u3000\u3000.::::/ \u3000\u3000 ::::l\u3000\u3000\u3000 :l '\u00b4\u3000\u3000\u3000\u3000\uff40)'\uff40\u30fd \u30fe;\uff3c\n\u3000\u3000\u3000\u3000\u3000 \u3000\uff0f::{\uff9e\u3000\u30fd\u3001 \uff40`\u4e36\uff64;/\u2010\u2010- \uff64::::l\u3000\u3000 \u3000 `'::\u252c\u2010--\uff1c_ \u3000 } ./;:::::\uff3c\n\u3000\u3000\u3000\u3000\u3000\uff0f::::::::!\u3000\u3000 ,\uff1e---\u2010'\uff9e\uff70- ...__)\uff72\u3000,.\u3000-\u2010\u2010-\uff64\uff84\uff64\u3000\u3000 |l::\u30fd \uff0f;';';';';::::\uff3c\n  \u3000 \u3000 \uff0f|::::::;';';'\uff3c\uff0f\uff5d\u3000\uff08\u30fd\u3001\u3000\u3000_/| \u3000 (\u00b4\u3000\u3000\u3000 _,.\uff68!::\u30fd. \u3000\u30fe\uff70'\u00b4;';';';';';';';';:: /\u30fd\u3001\n")};
})();
