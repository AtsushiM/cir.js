...
j.Base=j.klass({init:function(a){a=a||{};this.k={};this.Ca=a.single},properties:{F:0,m:function(a){if(this.Ca){if(j[a].o)return j[a].o;j[a].o=this}return this},dispose:function(){var a;if(this.k)for(a in this.k)J.apply(A,this.k[a]);for(a in this)delete this[a];return this.__proto__=A},contract:function(a,b,c){I(a,b,c);this.F++;this.k[this.F]=[a,b,c];return this.F},uncontract:function(a){var b=this.k[a];delete this.k[a];J(b[0],b[1],b[2])},b:function(){this.__proto__.__proto__.dispose.call(this)}}});
...
R=j.Animation=k(function(a,b,c){c=c||{};this.C=c.onComplete||z;this.a=a;R.id++;this.c="ciranim"+R.id;a=c.duration||R.duration;var d=c.ease||"ease",e,g={};for(e in b)g[e]=b[e],ia(g[e])&&(g[e]+="px");this.h=g;g=ga(ga(da(g),'"',""),",",";");Q.insertRule("@"+Ha+"keyframes "+this.c+"{to"+g+"}",Q.cssRules.length);ma(d)||(d=[d]);b=this.c;e=0;for(var g=d.length,h="";e<g;e++)h+=Ha+"animation:"+b+" "+a+"ms "+d[e]+" 0s 1 normal both;";Q.insertRule("."+b+"{"+h+"}",Q.cssRules.length);c.manual||this.start()},{Y:function(){J(this.a,
Ia+"End",this.end);J(this.a,"animationend",this.end)},dispose:function(){this.stop();this.b()},start:function(){function a(a){var d=Q.cssRules,e=d.length,g;b.Y();if("webkit"===Ga){for(;e--;)g=d[e].name||(""+d[e].selectorText).split(".")[1],g===b.c&&Q.deleteRule(e);H(b.a,b.c);K(b.a,b.h)}b.C(a)}var b=this;b.end=a;I(b.a,Ia+"End",a);I(b.a,"animationend",a);G(b.a,b.c)},stop:function(){var a={};a[Ha+"animation-play-state"]="paused";K(this.a,a);this.Y()}});R.id=0;R.duration=500;R.support=Fa;
...
start:function(){var a=this;a.t=function(b){a.stop();setTimeout(function(){a.Ra.onComplete(b)},1)};I(a.a,La+"End",a.t);I(a.a,"transitionend",a.t);G(a.a,a.c);K(a.a,a.h)},stop:function(){var a=U.cssRules,b=a.length,c;J(this.a,La+"End",this.t);J(this.a,"transitionend",this.t);for(H(this.a,this.c);b--;)if(c=a[b].name||(""+a[b].selectorText).split(".")[1],c===this.c){U.deleteRule(b);break}}});V.id=0;V.support=Ja;V.duration=500;
...
j.DragFlick=k(function(a){this._super();a&&this.attach(a)},{H:function(a){return a.changedTouches?a.changedTouches[0]:a},amount:function(a){var b=this,c,d,e=m;this.contract(a.element,N.switchdown,function(a){var h=b.H(a);c=h.pageX;d=h.pageY;e=q;oa(a)});this.contract(t,N.switchup,function(g){e&&(g=b.H(g),a.callback({x:g.pageX-c,y:g.pageY-d}),e=m)})},direction:function(a){this.amount({element:a.element,callback:function(b){var c=a.boundary||0,d={change:m,top:m,right:m,bottom:m,left:m,amount:b};Math.abs(b.x)>
c&&(0<b.x?d.right=q:0>b.x&&(d.left=q),d.change=q);Math.abs(b.y)>c&&(0<b.y?d.bottom=q:0>b.y&&(d.top=q),d.change=q);a.callback(d)}})},attach:function(a){function b(a,b,d){c.contract(a,b,function(a){d(c.H(a))})}var c=this,d=a.element,e=a.start||z,g=a.move||z,h=a.end||z,n=m,v=0,F=0;a.direction&&c.direction({element:d,boundary:a.boundary,callback:a.direction});b(d,N.switchdown,function(a){n=q;v=a.pageX;F=a.pageY;e({e:a,move:{x:v,y:F}})});b(D,N.switchmove,function(a){n&&g({e:a,move:{x:a.pageX-v,y:a.pageY-
F}})});b(D,N.switchup,function(a){n&&(h({e:a,move:{x:a.pageX-v,y:a.pageY-F}}),n=m)})}});j.ExternalInterface=function(a){a=a||{};var b=j.ExternalInterface,c;if(a.single&&b.o)return b.o;c=a.android?new b.Android(a):new b.IOS(a);a.single&&(b.o=c);return c};
...
j.Mobile=k(function(){this._super()},{getZoom:function(){return D.body.clientWidth/t.innerWidth},isAndroid:function(a){return B(/Android/i,a)},isIOS:function(a){return B(/iPhone|iPad|iPod/i,a)},isWindows:function(a){return B(/IEMobile/i,a)},isFBAPP:function(a){return B(/FBAN/,a)},isMobile:function(){return this.isAndroid()||this.isIOS()||this.isWindows()||this.isFBAPP()},killScroll:function(a){if(this.B)return m;a||w();this.B=this.contract(D,N.touchmove,oa)},revivalScroll:function(a){if(!this.B)return m;
a||w();this.uncontract(this.B);delete this.B},hideAddress:function(){function a(){0===t.pageYOffset&&w()}function b(){setTimeout(a,100)}this.contract(t,N.load,b,m);this.contract(t,Ea,b,m)},getOrientation:function(){return 90!==Math.abs(t.orientation)&&t.innerWidth<t.innerHeight?{portrait:q,landscape:m}:{portrait:m,landscape:q}},attachOrientation:function(a){function b(a){h.push(g.contract(t,N.load,a));h.push(g.contract(t,Ea,a));h.push(g.contract(t,N.resize,a))}function c(){for(var a=h.length;a--;)g.uncontract(h[a]);
h=[]}function d(){e();c()}function e(){if(g.getOrientation().portrait)return a.portrait(),q;a.landscape()}var g=this,h=[];a.immediately&&e();if(a.one)return b(d),function(){c()};b(e);return function(){c()}}});j.mobile=new j.Mobile;j.T=k(function(a){this._super();this.s=a.e;a.callback&&this.attach(a.callback)},{attach:function(a){this.detach();this.U=this.contract(t,this.s,a)},detach:function(){this.U&&this.uncontract(this.U)}});j.DeviceOrientation=function(a){a=a||{};a.e="deviceorientation";return new j.T(a)};
...
j.DeviceShake=k(function(a){this._super();this.G=new Va;this.va=a.limit;this.Da=a.waittime;a.callback&&a.direction&&this.attach(a.direction,a.callback)},{Ha:{x:"gamma",y:"beta",z:"alpha"},dispose:function(){this.G.dispose();this.b()},attach:function(a,b){a=this.Ha[a];var c=this,d;return c.G.attach(function(e){e=Wa(e);d||(d=e);Math.abs(e[a]-d[a])>c.va&&(d=A,b(e),setTimeout(function(){},c.Da))})},detach:function(){this.G.detach()}});j.DeviceShake.support=Va?q:m;
...
j.Timer=function(a){function b(){S=u();var a=g-(S-ya)/1E3;0>a&&(a=0);Ba=c(a);v(Ba);if(S>za)return Ta.stop(),F(),q;Ua=setTimeout(b,n);return m}function c(a){var b;b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({ma:a,da:xa.Na});b=d({ma:b,da:xa.Ma,Oa:q});return a+"."+b}function d(a){var b=""+a.ma,c=a.da,d=c-b.length;return!a.Oa?-1<d?e(d,0)+b:e(c,9):0<d?b+e(d,0):b.slice(0,c)}function e(a,b){var c="";for(b=""+b;0<a;)c+=b,a--;return c}var g=a.limit,h=1E3*g,n=1E3*a.interval,v=a.onupdate,F=a.ontimeup,xa;a=
a.template.split(".");xa={Na:a[0].length,Ma:a[1].length};var ya=0,S=0,za=h,Ba=c(g),Ua,Ta={getLimit:function(){return g},getTime:function(){return Ba},getProgress:function(){return 1-(za-S)/h},setUpdate:function(a){v=a},setTimeup:function(a){F=a},countDown:function(){S=ya=u();za=ya+h;b()},stop:function(){clearInterval(Ua)}};return Ta};
