...
d.Loading=d.klass({init:function(a){if(a&&a.onload)this.onload(a.onload)},properties:{utility:d.utility,_event:new d.Event,onload:function(a){this.utility.onEvent(this.utility.win,this._event.load,a)}}});d.LocalStorage=d.klass({init:function(a){a=a||{};if(a.single&&d.LocalStorage.instance)return d.LocalStorage.instance;a.single&&(d.LocalStorage.instance=this)},properties:{utility:d.utility,storage:d.utility.win.localStorage,set:function(a,b){this.storage.setItem(a,JSON.stringify(b));return!0},get:function(a){if(a)return JSON.parse(this.storage.getItem(a));
...
d.klass({init:function(a){a=a||{};if(a.single&&d.SessionStorage.instance)return d.SessionStorage.instance;a.single&&(d.SessionStorage.instance=this)},properties:{utility:d.utility,storage:d.utility.win.sessionStorage,set:function(a,b){this.storage.setItem(a,JSON.stringify(b));return!0},get:function(a){if(a)return JSON.parse(this.storage.getItem(a));var a={},b;for(b in this.storage)a[b]=JSON.parse(this.storage[b]);return a},remove:function(a){if(!this.storage.getItem(a))return!1;this.storage.removeItem(a);
return!0},reset:function(){this.storage.clear();return!0}}});d.SessionStorage.instance=null;d.Surrogate=d.klass({init:function(a){this.delay=a.delay;this.callback=a.callback;this.waitid=this.args=null},properties:{request:function(a){this.args=a;this.clear();this.waitid=setTimeout(this.flush,this.delay,this)},flush:function(a){a=a||this;a.callback(a.args)},clear:function(){clearInterval(this.waitid)}}});d.Throttle=d.klass({init:function(a){this.waittime=a.waittime;this.callback=a.callback;this.locked=
!1;this.waitarg=this.waitid=null},properties:{request:function(a){var b=this;if(b.locked)return b.waitarg=a,!1;b.callback(a);b.lock();b.waitid=setTimeout(function(){b.waitarg&&(b.callback(b.waitarg),b.waitarg=null);b.unlock()},b.waittime,b)},lock:function(){this.locked=!0},unlock:function(a){a=a||this;a.locked=!1;clearInterval(a.waitid)}}});d.Timer=function(a){function b(){m=Date.now();var a=f-(m-l)/1E3;0>a&&(a=0);p=c(a);i(p);if(m>o)return r.stop(),k(),!0;q=setTimeout(b,j);return!1}function c(a){var b;
b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({num:a,digit:n.integer});b=d({num:b,digit:n.few,isFew:!0});return a+"."+b}function d(a){var b=""+a.num,c=a.digit,e=c-b.length;return!a.isFew?-1<e?g(e,0)+b:g(c,9):0<e?b+g(e,0):b.slice(0,c)}function g(a,b){for(var c="",b=""+b;0<a;)c+=b,a--;return c}var f=a.limit,h=1E3*f,j=1E3*a.interval,i=a.onupdate,k=a.ontimeup,n=function(a){a=a.split(".");return{integer:a[0].length,few:a[1].length}}(a.template),l=0,m=0,o=h,p=c(f),q,r={getLimit:function(){return f},getTime:function(){return p},
getProgress:function(){return 1-(o-m)/h},setUpdate:function(a){i=a},setTimeup:function(a){k=a},countDown:function(){m=l=Date.now();o=l+h;b()},stop:function(){clearInterval(q)}};return r};d.Tweener=d.klass({init:function(a,b,c){var e,c=c||{};this.target=a;this.property=[];for(e in b)a=b[e],a.name=e,a.distance=a.to-a.from,a.prefix=a.prefix||"",a.suffix=a.suffix||"px",this.property.push(a);this.duration=c.duration||d.Tweener.Duration;this.easing=c.easing||this._easing;this.onComplete=c.onComplete;this.begin=
