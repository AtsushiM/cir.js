...
nullFunction:q,preventDefault:Z,checkUserAgent:E};e.element={$:$,$$:function(a){return aa(a,p)},$child:function(a,b){return b.querySelector(a)},$$child:aa,$id:function(a){return p.getElementById(a)},on:m,off:s,create:u,show:ca,hide:da,opacity:ra,hasClass:F,addClass:G,removeClass:H,toggleClass:pa,css:I,computedStyle:sa,append:N,parent:function(a){return a.parentNode},remove:ta,attr:ba,removeAttr:qa,html:ua};var g=e.klass=function(a){var b=a.init||function(){},c=a.properties;(a=a.extend)&&e.extend(b,
a);S(b.prototype,c);return b};e.extend=function(a,b){function c(){this.init=a}c.prototype=b.prototype;a.prototype=new c;var d=a.prototype;d._superclass=b;d._super=function(){var a=this._prevctor,a=a?a.prototype._superclass:this._prevctor=b;a.apply(this,arguments)}};var j=oa(),l,O="orientationchange";l=g({init:function(a){a=a||{};if(a.single&&e.Event.instance)return e.Event.instance;a.single&&(e.Event.instance=this)},properties:{switchclick:j?"touchstart":"click",switchdown:j?"touchstart":"mousedown",
switchmove:j?"touchmove":"mousemove",switchup:j?"touchend":"mouseup",load:"load",change:"change",click:"click",mousedown:"mousedown",mousemove:"mousemove",mouseup:"mouseup",touchstart:"touchstart",touchmove:"touchmove",touchend:"touchend",resize:"resize"}});e.Event=l;l=e.event=new l;j=e.Base=g({properties:{dispose:function(){var a;if(this._dispose)for(a=this._dispose.lenght;a--;)s.call(null,this._dispose[a]);for(a in this)delete this[a];this.__proto__=null}}});e.ease={linear:function(a,b,c,d){return c*
...
"cubic-bezier(0.680, -0.550, 0.265, 1.550)"]};for(var r=["webkitAnimation","animation"],ea=u("p"),fa=!1,P,Q="",ga="animation",v=0,ha=r.length,y,z;v<ha;v++)if(void 0!==ea.style[r[v]]){fa=!0;if(P=r[v].match(/^(.*?)animation$/i)[1])Q="-"+P.toLowerCase()+"-",ga=P+"Animation";r=N($("head"),u("style",{type:"text/css"}));y=r.sheet;break}z=e.Animation=g({extend:j,init:function(a,b,c){if(!fa)return!1;c=c||{};this.onComplete=c.onComplete||q;this.element=a;z.id++;this.id="ciranim"+z.id;a=c.duration||z.Duration;
...
function(a){if(!h.HTMLAudioElement)return!1;for(var b=new Audio(""),c=a.suffix||[["mp3","mpeg"],["wav","wav"],["ogg","ogg"],["m4a","mp4"]],d=[],f=0,e=c.length;f<e;f++)b.canPlayType("audio/"+c[f][1])&&d.push([c[f][0]]);if(0===d.length)return!1;b.controls=a.controls?!0:!1;b.preload=a.preload||"auto";b.autoplay=a.autoplay?!0:!1;b.loop=a.loop?!0:!1;b.src=a.dir+a.name+"."+d[0];return b};e.Sound=g({extend:j,init:function(a){this._dispose=[];var b=this,c=a.autoplay,d=a.loop,f;a.preload="auto";a.controls=
...
this.request(a)}}});e.Bind=g({extend:j,init:function(a){this.handler=a;this.add()},properties:{dispose:function(){this.remove();this.__proto__.__proto__.dispose.call(this,[])},getHandler:function(){return this.handler},add:function(){this._e(!0)},remove:function(){this._e(!1)},_e:function(a){a=a?m:s;for(var b in this.handler.events)a(this.handler.element,b,this.handler.events[b])}}});e.Brush=g({extend:j,init:function(a){this.canvas=a.canvas;this.ctx=this.canvas.getContext("2d");this.setSize(a)},properties:{setSize:function(a){a.width&&
...
0,this.canvas.width,this.canvas.height);b<c;b++)d=a[b],this.ctx.drawImage(d.image,d.x,d.y)}}});e.DataStore=g({extend:j,init:function(a){a=a||{};if(a.single&&e.DataStore.instance)return e.DataStore.instance;this.data={};a.single&&(e.DataStore.instance=this)},properties:{set:function(a,b){this.data[a]=b},get:function(a){var b={},c;if(a)return this.data[a];for(c in this.data)b[c]=this.data[c];return b},remove:function(a){if(!this.data[a])return!1;delete this.data[a]},reset:function(){this.data={}}}});
e.Deferred=g({extend:j,init:function(){this.queue=[];this.data=null},properties:{isResolve:function(){return!this.queue},resolve:function(a){if(this.isResolve())return this;var b=this.queue,c=b.length,d=0;this.queue=null;for(this.data=a;d<c;++d)b[d](a);return this},done:function(a){this.queue?this.queue.push(a):a(this.data);return this}}});e.DragFlick=g({extend:j,init:function(a){this._dispose=[];a&&this.bind(a)},properties:{_t:function(a){return a.changedTouches?a.changedTouches[0]:a},amount:function(a){function b(a){var b=
...
c.parseHash(a);return b(a.vars)}},removeCallback:function(a){delete this.externalObj[a]}}});e.ExternalInterface.IOS=g({extend:e.HashController,init:function(){this.ios={}},properties:{dispose:function(){for(var a in this.ios)this.removeCallback(a);this.__proto__.__proto__.dispose.call(this,[])},call:function(a){this.setHash(a)},addCallback:function(a,b){var c=this;c.ios[a]=function(){var d=c.getHash();return d.mode===a?(b(d.vars),!0):!1};m(h,"hashchange",c.ios[a])},removeCallback:function(a){s(h,
"hashchange",this.ios[a]);delete this.ios[a]}}});e.Facebook=g({extend:j,properties:{_b:"https://www.facebook.com/dialog/feed?",getShareURL:function(a){var b=this._b+"app_id="+a.app_id+"&redirect_uri="+a.redirect_uri;return b+=M({link:a.link,picture:a.picture,name:a.name,caption:a.caption,description:a.description})}}});e.FPS=g({extend:j,init:function(a){a=a||{};a.criterion||(a.criterion=20);if(a.single&&e.FPS.instance)return e.FPS.instance;this.surver=this.criterion=a.criterion;this.enterframe=a.enterframe;
this.msecFrame=this._getFrame(this.criterion);this.prevtime=this.nowtime=this.loopid=0;a.manual||this.start();a.single&&(e.FPS.instance=this)},properties:{dispose:function(){this.stop();this.__proto__.__proto__.dispose.call(this,[])},getCriterion:function(){return this.criterion},getSurver:function(){return this.surver},getFrameTime:function(){return this.msecFrame},enter:function(){this.enterframe({criterion:this.criterion,surver:this.surver})},start:function(){this.prevtime=Date.now();this.loopid=
setInterval(this._loop,this.msecFrame,this)},_loop:function(a){a.nowtime=Date.now();a.surver=a._getFrame(a.nowtime-a.prevtime);a.prevtime=a.nowtime;a.enter()},_getFrame:function(a){return Math.round(1E3/a)},stop:function(){clearInterval(this.loopid)}}});e.ImgLoad=g({extend:j,init:function(a){this._dispose=[];this.srcs=a.srcs;this.srccount=this.srcs.length;this.loadedsrcs=[];this.onload=a.onload||q;this.onprogress=a.onprogress||q;this.progress=this.loadcount=0;this.started=!1;a.manual||this.start()},
properties:{_c:function(){this.loadcount++;this.progress=this.loadcount/this.srccount;this.onprogress(this.progress);if(this.loadcount>=this.srccount)this.onload(this.loadedsrcs)},start:function(){function a(){b._c()}if(this.started)return!1;this.started=!0;for(var b=this,c,d=0,f=b.srccount;d<f;d++)c=u("img"),c.src=b.srcs[d],m(c,l.load,a),this._dispose.push([c,l.load,a]),b.loadedsrcs.push(c)},getProgress:function(){return this.progress}}});e.WindowLoad=g({extend:j,init:function(a){this._dispose=[];
if(a&&a.onload)this.onload(a.onload)},properties:{onload:function(a){m(h,l.load,a);this._dispose.push(h,l.load,a)}}});e.LocalStorage=g({extend:j,init:function(a){a=a||{};if(a.single&&e.LocalStorage.instance)return e.LocalStorage.instance;this._n=a.namespace?a.namespace+"-":"";a.single&&(e.LocalStorage.instance=this)},properties:{_s:h.localStorage,set:function(a,b){this._s.setItem(this._n+a,JSON.stringify(b));return!0},get:function(a){var b={},c;if(a)return JSON.parse(this._s.getItem(this._n+a));for(c in this._s)this._n?
(a=c.split(this._n)[1])&&(b[a]=JSON.parse(this._s[c])):b[c]=JSON.parse(this._s[c]);return b},remove:function(a){a=this._n+a;if(!this._s.getItem(a))return!1;this._s.removeItem(a);return!0},reset:function(){if(!this._n)return this._s.clear(),!0;for(var a in this._s)this.remove(a)}}});e.Mobile=g({extend:j,init:function(){this._dispose=[]},properties:{getZoom:function(){return p.body.clientWidth/h.innerWidth},isAndroid:function(a){return E(/Android/i,a)},isIOS:function(a){return E(/iPhone|iPad|iPod/i,
a)},isWindows:function(a){return E(/IEMobile/i,a)},isFBAPP:function(a){return E(/FBAN/,a)},isMobile:function(){return this.isAndroid()||this.isIOS()||this.isWindows()||this.isFBAPP()},killScroll:function(a){a||L();m(p,l.touchmove,Z)},revivalScroll:function(a){a||L();s(p,l.touchmove,Z)},hideAddress:function(){function a(){0===h.pageYOffset&&L()}function b(){setTimeout(a,100)}m(h,l.load,b,!1);m(h,O,b,!1);this._dispose.push([h,l.load,b]);this._dispose.push([h,O,b])},getOrientation:function(){return 90!==
Math.abs(h.orientation)&&h.innerWidth<h.innerHeight?{portrait:!0,landscape:!1}:{portrait:!1,landscape:!0}},bindOrientation:function(a){function b(a,b){a(h,l.load,b);a(h,O,b);a(h,l.resize,b);f._dispose.push([h,l.load,b]);f._dispose.push([h,O,b]);f._dispose.push([h,l.resize,b])}function c(){d();b(s,c)}function d(){if(f.getOrientation().portrait)return a.portrait(),!0;a.landscape()}var f=this,e;a.immediately&&d();if(a.one)return b(m,c),function(){b(s,c)};b(m,d);e=function(){b(s,d)};f._dispose.push(e);
return e}}});e.FontImg=g({extend:j,init:function(a){a=a||{type:""};this.type=a.type?a.type+"_":"";this.tag=a.tag||"span"},properties:{make:function(a){a=(""+a).split("");var b="",c;for(c=a.length;c--;)b="<"+this.tag+' class="font_'+this.type+a[c]+'">&nbsp;</'+this.tag+">"+b;return b}}});e.Observer=g({extend:j,init:function(a){a=a||{single:!1};if(a.single&&e.Observer.instance)return e.Observer.instance;this.observed={};a.single&&(e.Observer.instance=this)},properties:{on:function(a,b){var c=this.observed;
c[a]||(c[a]=[]);c[a].push(b)},one:function(a,b){var c=this,d=function(f){b(f);c.off(a,d)};c.on(a,d)},off:function(a,b){var c=this.observed;if(!b)return delete c[a],!0;var d=c[a],f;if(!d)return!1;for(f=d.length;f--;)if(b===d[f])return d.splice(f,1),0===d.length&&delete c[a],!0;return!1},fire:function(a,b){var c=this.observed[a],d,f;if(!c)return!1;for(f=c.length;f--;)(d=c[f])&&d(b);return!0}}});e.PreRender=g({extend:j,init:function(a){a=a||{};a.loopblur||(a.loopblur=20);this.elements=a.elements||[];
...
a.onrendered()}},this.looptime,this)}}});e.Route=g({extend:j,init:function(a){if(a.single&&e.Route.instance)return e.Route.instance;this.target=a.target||"";this.noregex=a.noregex;this.action=a.action;a.manual||this.start();a.single&&(e.Route.instance=this)},properties:{start:function(){this.fire(this.target)},fire:function(a){var b;if(this.noregex&&this.action[a])return this.action[a](a);for(b in this.action)if(a.match(b))this.action[b](b)}}});e.ScriptLoad=g({extend:j,init:function(){this._dispose=
[];this.elements=[]},properties:{requests:function(a,b){function c(c){var e=a[c].callback;a[c].callback=function(a){e(a);f--;0===f&&b(d.elements)};d.request(a[c])}for(var d=this,f=0,e=a.length;f<e;f++)c(f)},request:function(a){var b=u("script");b.src=a.src;p.body.appendChild(b);this.elements.push(b);a.callback&&(m(b,l.load,a.callback),this._dispose.push([b,l.load,a.callback]))}}});var A=function(a){return ya?J.getResponseHeader(a):!1},za=function(a){var b=new XMLHttpRequest;b.onload=function(){a(b)};
b.open("HEAD",location.href+"?update"+Date.now()+"=1");b.send(null);return b},J,ya=!1;e.ServerMeta=g({extend:j,init:function(a){a=a||{};var b=a.callback||q;J?b(J):J=za(function(){ya=!0;b(J)})},properties:{date:function(a){return za(function(b){b=new Date(b.getResponseHeader("Date"));a(b)})},connection:function(){return A("Connection")},contentLength:function(){return A("Content-Length")},lastModified:function(){return A("Last-Modified")},server:function(){return A("Server")},contentType:function(){return A("Content-Type")},
acceptRanges:function(){return A("Accept-Ranges")},keepAlive:function(){return A("Keep-Alive")}}});e.SessionStorage=g({extend:j,init:function(a){a=a||{};if(a.single&&e.SessionStorage.instance)return e.SessionStorage.instance;this._n=a.namespace?a.namespace+"-":"";a.single&&(e.SessionStorage.instance=this)},properties:{_s:h.sessionStorage,set:function(a,b){this._s.setItem(this._n+a,JSON.stringify(b));return!0},get:function(a){var b={},c;if(a)return JSON.parse(this._s.getItem(this._n+a));for(c in this._s)this._n?
(a=c.split(this._n)[1])&&(b[a]=JSON.parse(this._s[c])):b[c]=JSON.parse(this._s[c]);return b},remove:function(a){a=this._n+a;if(!this._s.getItem(a))return!1;this._s.removeItem(a);return!0},reset:function(){if(!this._n)return this._s.clear(),!0;for(var a in this._s)this.remove(a)}}});e.Surrogate=g({extend:j,init:function(a){this.delay=a.delay;this.callback=a.callback},properties:{dispose:function(){this.clear();this.__proto__.__proto__.dispose.call(this,[])},request:function(a){this.args=a;this.clear();
this.waitid=setTimeout(this.flush,this.delay,this)},flush:function(a){a=a||this;a.callback(a.args)},clear:function(){clearInterval(this.waitid)}}});e.Throttle=g({extend:j,init:function(a){this.waittime=a.waittime;this.callback=a.callback},properties:{dispose:function(){this.unlock();this.__proto__.__proto__.dispose.call(this,[])},request:function(a){var b=this;if(b.locked)return b.waitarg=a,!1;b.callback(a);b.lock();b.waitid=setTimeout(function(){b.waitarg&&(b.callback(b.waitarg),b.waitarg=null);
b.unlock()},b.waittime,b)},lock:function(){this.locked=!0},unlock:function(a){a=a||this;a.locked=!1;clearInterval(a.waitid)}}});e.Timer=function(a){function b(){n=Date.now();var a=e-(n-m)/1E3;0>a&&(a=0);q=c(a);j(q);if(n>p)return s.stop(),g(),!0;r=setTimeout(b,h);return!1}function c(a){var b;b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({num:a,digit:l.integer});b=d({num:b,digit:l.few,isFew:!0});return a+"."+b}function d(a){var b=""+a.num,c=a.digit,d=c-b.length;return!a.isFew?-1<d?f(d,0)+b:f(c,9):0<
d?b+f(d,0):b.slice(0,c)}function f(a,b){var c="";for(b=""+b;0<a;)c+=b,a--;return c}var e=a.limit,k=1E3*e,h=1E3*a.interval,j=a.onupdate,g=a.ontimeup,l;a=a.template.split(".");l={integer:a[0].length,few:a[1].length};var m=0,n=0,p=k,q=c(e),r,s={getLimit:function(){return e},getTime:function(){return q},getProgress:function(){return 1-(p-n)/k},setUpdate:function(a){j=a},setTimeup:function(a){g=a},countDown:function(){n=m=Date.now();p=m+k;b()},stop:function(){clearInterval(r)}};return s};for(var r=["webkitTransitionProperty",
"transitionProperty"],ea=u("p"),la=!1,Aa="",ma="transition",v=0,ha=r.length,K,B;v<ha;v++)if(void 0!==ea.style[r[v]]){la=!0;if(r=r[v].match(/^(.*?)transitionproperty$/i)[1])Aa="-"+r.toLowerCase()+"-",ma=r.toLowerCase()+"Transition";r=N($("head"),u("style",{type:"text/css"}));K=r.sheet;break}B=e.Transition=g({extend:j,init:function(a,b,c){if(!la)return!1;c=c||{};c.onComplete=c.onComplete||q;B.id++;this.id="cirtrans"+B.id;var d=[];S({},b);var e,h=c.duration||B.Duration,k=c.ease||"ease";Y(k)||(k=[k]);
for(e in b)d.push(e);e=this.id;for(var j=Aa,g=0,l=k.length,d=""+(j+"transition-property:"+d.join(" ")+";"+j+"transition-duration:"+h+"ms;");g<l;g++)d+=j+"transition-timing-function:"+k[g]+";";K.insertRule("."+e+"{"+d+"}",K.cssRules.length);this.element=a;this.property=b;this.option=c;c.manual||this.start()},properties:{dispose:function(){this.stop();this.__proto__.__proto__.dispose.call(this,[])},start:function(){var a=this;a._endfunc=function(b){a.stop();setTimeout(function(){a.option.onComplete(b)},
1)};m(a.element,ma+"End",a._endfunc);m(a.element,"transitionend",a._endfunc);G(a.element,a.id);I(a.element,a.property)},stop:function(){var a=K.cssRules,b=a.length,c;s(this.element,ma+"End",this._endfunc);s(this.element,"transitionend",this._endfunc);for(H(this.element,this.id);b--;)if(c=a[b].name||(""+a[b].selectorText).split(".")[1],c===this.id){K.deleteRule(b);break}}}});B.id=0;B.support=la;B.Duration=500;var n=e.Tweener=g({extend:j,init:function(a,b,c){var d;c=c||{};this.target=a;this.property=
[];for(d in b)a=b[d],a.name=d,a.distance=a.to-a.from,a.prefix=a.prefix||"",a.suffix=a.suffix||"px",this.property.push(a);this.duration=c.duration||n.Duration;this.ease=c.ease||this._ease;this.onComplete=c.onComplete;c.manual||this.start()},properties:{dispose:function(){this.stop();this.__proto__.__proto__.dispose.call(this,[])},_ease:function(a,b,c,d){return c*(-Math.pow(2,-10*a/d)+1)+b},_requestAnimationFrame:h.requestAnimationFrame?function(a){requestAnimationFrame(a)}:h.webkitRequestAnimationFrame?
function(a){webkitRequestAnimationFrame(a)}:h.mozRequestAnimationFrame?function(a){mozRequestAnimationFrame(a)}:h.oRequestAnimationFrame?function(a){oRequestAnimationFrame(a)}:h.msRequestAnimationFrame?function(a){msRequestAnimationFrame(a)}:function(a){setTimeout(a,1E3/n.FPS)},loop:function(){for(var a=this,b=n.Items,c,d=Date.now(),e,h=b.length,k,j,g;h--;)if(c=b[h],j=c.property.length,e=d-c.begin,e<c.duration)for(k=0;k<j;k++)g=c.property[k],n._setProp(c.target,g,c.ease(e,g.from,g.distance,c.duration));
else{for(k=0;k<j;k++)g=c.property[k],n._setProp(c.target,g,g.to);if(c.onComplete)c.onComplete();b.splice(h,1)}if(b.length)return a._requestAnimationFrame(function(){a.loop()}),!0;this.stop()},start:function(){var a=this;a.begin=Date.now();n.Items.push(a);n.timerId||(n.timerId=1,a._requestAnimationFrame(function(){a.loop()}))},stop:function(){n.Items=[];clearInterval(n.timerId);n.timerId=null}}});n._setProp=function(a,b,c){a[b.name]=b.prefix+c+b.suffix};n.Items=[];n.FPS=30;n.Duration=500;e.Twitter=
g({extend:j,properties:{_b:"https://twitter.com/intent/tweet?",getShareURL:function(a){var b=a.caption||"",c=a.name,d=a.hash,e=this._b;return e+=M({url:a.redirect_uri,text:b+(c?" \u300c"+c+"\u300d":"")+(d?" "+d:"")})}}});e.XML=g({extend:j,init:function(a){this.element=u("div");this.data={};a&&a.data&&this.setData(a.data)},properties:{getData:function(){return this.data},setData:function(a){this.data=this.element.innerHTML=a},$:function(a){return this.element.querySelector(a)},$$:function(a){return aa(a,
